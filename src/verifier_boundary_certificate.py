...
class VerifierBoundaryCertificate:
    theorem_id: str
    status: str
    required_count: int
    present_count: int
...
def verifier_boundary_certificate(root: Path | str, required: Sequence[str], boundary_text: str) -> VerifierBoundaryCertificate:
    normalized = _normalize_required(required)
    ...
    return VerifierBoundaryCertificate(
        theorem_id="UV-VBC-1",
